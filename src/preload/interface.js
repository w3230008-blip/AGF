...
export const titleLangApi = {
  /**
   * @param {string} videoId
   * @returns {Promise<{ ok: boolean, status?: number, title?: string | null, error?: string, message?: string, statusText?: string }>>}
   */
  fetchOEmbed: (videoId) => {
    return ipcRenderer.invoke(IpcChannels.TITLE_LANG_OEMBED_FETCH, videoId)
  }
}
