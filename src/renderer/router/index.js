  ...
  scrollBehavior(to, from, savedPosition) {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        } else if (to.name === 'settings' && to.query.section) {
          // Don't auto-scroll when navigating to a specific settings section
          // Let the Settings component handle scrolling to the requested section
          resolve(false)
        } else {
          resolve({ x: 0, y: 0 })
        }
