<template>
  ...
  >
    ...
    <ft-custom-progress-bar
      v-if="customProgressBarEnabled"
      :enabled="customProgressBarEnabled"
      :current-time="progressBarCurrentTime"
      :duration="progressBarDuration"
      :buffered-time="progressBarBufferedTime"
      :chapters="chapters"
      @seek="handleCustomProgressBarSeek"
    />
    <!--
    ...
    <ft-custom-subtitle-display
      ...
      :current-subtitle-text="currentCustomSubtitleText"
    />
  </div>
</template>
