      ...
      try {
        ...
        if ((!this.isUpcoming && !this.isLive && !this.isPostLiveDvr) || (this.isUpcoming && this.playabilityStatus === 'OK')) {
          ...
          if (result.streaming_data) {
            ...
            // Extract available audio languages for multi-language support
            if (result.availableAudioLanguages && result.availableAudioLanguages.length > 0) {
              this.availableAudioLanguages = result.availableAudioLanguages
              console.warn('[MultiAudio] Available languages in Watch component:', this.availableAudioLanguages)
            } else {
